...
const palaceText = (language) => {
  let rotationText, palaceEvents;

  if (language === "kr") {
    palaceEvents = palaceEventsKr;
    rotationText = rotationTextKr;
  } else {
    palaceEvents = palaceEventsEn;
    rotationText = rotationTextEn;
  }
  return { palaceEvents, rotationText };
};

const rotationTextKr = [
  {
    current: "gyeongbok",
    text: ["경복궁", "626"],
  },
  { current: "changdeok", text: ["창덕궁", "616"] },
  { current: "changgyeong", text: ["창경궁", "538"] },
  { current: "gyeonghui", text: ["경희궁", "389"] },
  { current: "deoksoo", text: ["덕수궁", "428"] },
];

const rotationTextEn = [
  {
    current: "gyeongbok",
    text: ["Gyeongbok", "626"],
  },
  { current: "changdeok", text: ["Changdeok", "616"] },
  { current: "changgyeong", text: ["Changgyeong", "538"] },
  { current: "gyeonghui", text: ["Gyeonghui", "389"] },
  { current: "deoksoo", text: ["Deoksoo", "428"] },
];

const palaceEventsKr = [
  {
    label: "경복궁",
    image: gyeongbok,
    events: [
...
const palaceEventsEn = [
  {
    label: "Gyeongbok Palace",
    image: gyeongbok,
    events: [
      {
        style: { type: "Basic" },
